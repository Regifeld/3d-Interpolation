...
#                    indices.append(len(vertices) - 1)
    ...
    def on_draw(self):
        ...
        mvMatrix = np.dot(self.cam, mvMatrix)
    ...
    def on_key_release(self, keycode, modifiers):
        ...
        #moves cam downward  
            ...
            movecam = ([[1,0,0,e],
                                  ...
                                  [0,0,1,0],
                                  [0,0,0,1]])
            self.transform = np.dot(self.transform, movecam)
            pass
        ...
        #
            ...
            movecam = ([[1,0,0,0],
                                  ...
                                  [0,0,1,e],
                                  [0,0,0,1]])
            self.cam = np.dot(self.cam, movecam)
            pass
        ...
        ##rotate X
            ...
            self.cam = np.dot(self.cam, self.rot_x(10))
            pass
        ...
        ##rotate Y
            ...
            self.cam = np.dot(self.cam, self.rot_y(10))
            pass
        ...
        ##rotate Z
            ...
            self.cam = np.dot(self.cam, self.rot_z(10))
            pass
